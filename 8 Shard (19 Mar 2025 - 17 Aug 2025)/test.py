...
# shard8_df = df[df["tx_shard"] == 9][["epoch_index", "avg_tps"]]

# # Save to a new CSV
# shard8_df.to_csv("shard9_epoch_tps.csv", index=False)
...
# # Filter only shard 8 data  
# shard8_df = df[df["rx_shard"] == 0][["epoch_index", "avg_latency_sec"]]

# # Save to a new CSV
# shard8_df.to_csv("shard0_epoch_latency.csv", index=False)
